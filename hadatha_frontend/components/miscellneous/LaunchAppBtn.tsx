...
const LaunchAppBtn = ({ buttonText = "Launch App", redirectUrl }: LaunchAppBtnProps) => {
    ...
    return (
        <>
            ...
            <ConnectWalletModal open={openConnectModal} setOpen={setOpenConnectModal} redirectUrl={redirectUrl} />
        </>
    )
}
