...
const CreateAccountForm = ({ onSuccess, onFailure }: CreateAccountFormProps) => {
    ...
    return (
        <div className="w-full max-w-lg p-8 rounded-3xl bg-white/5 backdrop-blur-2xl border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.36)] flex flex-col gap-8 relative z-10">
